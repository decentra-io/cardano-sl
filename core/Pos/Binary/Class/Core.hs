...
enforceSize lbl requestedSize =
    toDecoder D.decodeListLen >>= matchSize requestedSize lbl
...
decodeListLen = toDecoder D.decodeListLen

decodeListLenOf :: Int -> Decoder s ()
decodeListLenOf = toDecoder . D.decodeListLenOf
